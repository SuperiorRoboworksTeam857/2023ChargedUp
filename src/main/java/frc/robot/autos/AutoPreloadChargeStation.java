...
public class AutoPreloadChargeStation extends SequentialCommandGroup {
  public AutoPreloadChargeStation(RobotContainer robot) {
    ...
    PathPlannerTrajectory trajectory2 =
        PathPlanner.generatePath(
            ...
            new PathPoint(
                ...
                Rotation2d.fromDegrees(0)),
            new PathPoint(
                new Translation2d(Units.inchesToMeters(84), Units.inchesToMeters(0)),
                Rotation2d.fromDegrees(180),
                Rotation2d.fromDegrees(0)));
    ...
    addCommands(
        ...
        new InstantCommand(
            () -> robot.s_wrist.goToAngle(WristSubsystem.Positions.INTAKE), robot.s_elevator),
        new WaitUntilCommand(robot.s_wrist::isWristAtGoal),
        new WaitCommand(1),
        new InstantCommand(
            () -> robot.s_wrist.goToAngle(WristSubsystem.Positions.VERTICAL), robot.s_elevator),
        new InstantCommand(
